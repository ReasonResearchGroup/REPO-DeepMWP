...
class math23kDataLoader():
    def __init__(self,train_data,test_data,valid_data=None):
        super().__init__()
    ...
    def preprocess_and_word2vec(self, emb_dim):
        ...
        for elem in self.train_data:
            ...
            equation = elem['target_template'][2:]
    ...
    def loading(self,data_type,batch_size,postfix):
        """
        parameter: data_type : expect "train" ,"test" or "valid"
        """
        if data_type == "train":
        ...
        for i in range(batch):
            ...
            for d in batch_data:
                ...
                batch_tt.append(d['target_template'])
            loaded_data.append({'train_var':batch_var,'train_len':batch_len,'target_var':batch_tem_var,
                                ...
                                'num_list':batch_num_list,'solution':batch_solution,'equ':batch_tt})
        return loaded_data